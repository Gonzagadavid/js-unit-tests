...
// PASSO 2: Adicione ao objeto retornado por `createMenu` uma chave `consumption` que, como valor inicial, tem um
// array vazio.
//
...
// PASSO 4: Adicione ao objeto retornado por `createMenu()` uma chave `pay` com uma função que varre todo os itens
// de `objetoRetornado.consumption`,
// soma o preço de todos checando-os no menu e retorna o valor somado acrescido de 10%. DICA: para isso,
// você precisará varrer tanto o objeto da chave `food` quanto o objeto da chave `drink`.

let restaurant = {};

const insertConsumption = (string) => {
...
const createMenu = (object) => {
  restaurant = {
    fetchMenu: () => object,
    consumption: [],
    order: (string) => insertConsumption(string),
    pay: () => calcTotal(),
  };
  return restaurant;
};
